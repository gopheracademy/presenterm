...
import (
	...
	"github.com/gophertrain/presenterm/present"
)

const basePkg = "github.com/gophertrain/presenterm/cmd/present"
...
func main() {
	...
	flag.BoolVar(&present.DockerEnabled, "docker", false, "enable docker (permit execution of docker code on host machine)")
	flag.Parse()
